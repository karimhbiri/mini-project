  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Demande de tirage</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Demande de tirage</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      ...
      <div style="color: #efefef;" class="alert alert-secondary" role="alert">
	      <strong>Demande de torage!</strong> Planifier une demande de tirage du vos documents.
	  </div>
		  	...
		  	<div style="border-right: 1px solid #8f8f8f;" class="col-14 col-md-9">
				...
				<form action="MatiereController" method="post">
				    ...
				    <div class="input-group input-group-outline my-3">
				      ...
				      <input type="number" name="nbrCopie" class="form-control">
				    </div>
				    <div class="input-group input-group-outline my-3">
				      <label class="form-label">Enseignant:</label>
				      <input type="text" name="nomEnseignant" class="form-control">
				    </div>
				    <div class="input-group input-group-static my-3">
				      <label>Date:</label>
				      <input  style="color: #2a2a2a;filter: invert(1);border-bottom: 1px solid #5c5d5e;" type="date" name="date" class="form-control">
				    </div>
				    <div class="input-group input-group-static my-3">
				      <label>Heure:</label>
				      <input  style="color: #2a2a2a;filter: invert(1);border-bottom: 1px solid #5c5d5e;" type="time" name="heure" class="form-control">
				    </div>
				    <div class="input-group input-group-static my-3">
					    <div id='container'>
						  <div class='panel panel-primary'>
						    <div class='panel-body'>
						      ...
						      <h3>Télécharger votre fichier ici</h3>
						      <span id='result'></span><br>
						      <button class='btn btn-primary upload-btn' type="button" style="font-size: 9px;">Télécharger</button>
						      <input type='file' name ='file' id='upload-file' multiple>
						    </div>
						  </div>
						</div>
					  </div>
					  <div class="col-md-3" style="float: right; width:unset;">
						  <button class="btn bg-gradient-primary" type="submit">Créer</button>
