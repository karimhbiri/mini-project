			...
			<ul class="navbar-nav">
				...
				<c:if test="${role == 'Enseignant' }">
					...
					<li class="nav-item"><a
						...
						href="matieres.jsp">
							...
							</div> <span class="nav-link-text ms-1">Matieres</span>
					</a></li>
					...
					<li class="nav-item"><a class="nav-link text-white "
						href="demandetirage.jsp">
							<div
								class="text-white text-center me-2 d-flex align-items-center justify-content-center">
								<i class="material-icons opacity-10">task</i>
							</div> <span class="nav-link-text ms-1">Voir les demandes</span>
					</a></li>
				</c:if>
				...
				<li class="nav-item"><a class="nav-link text-white "
					href="Disconnect">
						...
						</div> <span class="nav-link-text ms-1">Se deconnecter</span>
				</a></li>
			</ul>
		</div>
	...
	<main
				...
				<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4"
					...
					<ul class="navbar-nav  justify-content-end">
						...
						%>
								...
								</c:if> <c:if test="${role == 'Agent de tirage'}">
									<%
		...
		<div class="container-fluid py-4">
			...
			<div style="color: #efefef;" class="alert alert-secondary"
				role="alert">
				<strong>Matiere!</strong> Ajouter votre matiere pour faciliter la
			...
			<div class="row">
				<div style="border-right: 1px solid #8f8f8f;"
					...
					<h3>
						Formulaire <small class="text-muted">Ajouter vos matieres!</small>
					</h3>
					<form action="MatiereController" method="post">
						<div class="input-group input-group-outline my-3">
							<label class="form-label">Nom de la matiere</label> <input
								type="text" name="nomMatiere" class="form-control">
						</div>
						<div class="input-group input-group-outline my-3">
							<label class="form-label">Alias (e.g: English, alias is
								EN)</label> <input type="text" name="alias" class="form-control">
						</div>
						<div class="input-group input-group-outline my-3">
							<label class="form-label">Module</label> <input type="text"
								name="module" class="form-control">
						</div>
				...
				<table>
					...
					<%
      						...
      						MetierDAO metierDao = new MetierDAO();
									List<Metier> lst = metierDao.getAllMetier();
									for (int i = 0; i < lst.size(); i++) {
								%>
					<tr>
						<td><%=lst.get(i).getName()%></td>
						<td><%=lst.get(i).getName() %></td>
						<td><%=lst.get(i).getAlias()%></td>
						<%
										out.println("<td>  <a class='btn btn-info' href ='MatiereController?id="
									...
									%>
						<%
										out.println(" <a class='btn btn-danger' href ='MatiereController?id="
