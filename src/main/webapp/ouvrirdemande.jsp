  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a class="opacity-5 text-dark" href="demandes.jsp">Suivre les demandes</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Info demande</li>
          </ol>
    ...
    <div class="container-fluid py-4">
      ...
      <div style="color: #efefef;" class="alert alert-secondary" role="alert">
	      <strong>Suivre cette demande!</strong> Vous pouvez changer le statut de cette demande.
	  </div>
