              ...
              <div class="card-body">
                ...
                <form role="form" class="text-start" action="AuthController" method="post">
                  ...
                  <div class="form-check form-switch d-flex align-items-center mb-3">
                    ...
                    <label class="form-check-label mb-0 ms-2" for="rememberMe">Souviens de moi</label>
                  </div>
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <a href="sign-up.jsp" class="text-primary text-gradient font-weight-bold">S'inscrire</a>
                  </p>
                </form>
              </div>
            </div>
